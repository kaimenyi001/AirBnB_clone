#!/usr/bin/python3
""" Module of Unittests for file_storage.py """
import unittest
...
class FileStorageTests(unittest.TestCase):
    ...
    def testStoreBaseModel(self):
        ...
        self.bm.full_name = "BaseModel Instance"
        self.bm.save()
    ...
    def test_save_FileStorage(self):
        """ Test if the new method is working efficiently """
        var1 = self.bm.to_dict()
